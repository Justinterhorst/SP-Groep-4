...
class HUWebshop(object):
    ...
    def productpage(self, cat1=None, cat2=None, cat3=None, cat4=None, page=1):
        ...
        if len(nononescats) != 0:
            ...
            type = 1 if (len(nononescats) == 1) else 2
            nononescats = nononescats[0] if (len(nononescats) == 1) else nononescats[1]
            if "-" in nononescats:
                category.append(nononescats.split("-")[len(nononescats.split("-")) - 1:][0])
            elif "-" not in nononescats:
                category.append(nononescats[1:len(nononescats) - 1:])
            category.append(type)
            print("Productpage   nononescats: {}   type: {}".format(category[0], category[1]))
        else:
            pagepath = "/producten/"
        return self.renderpackettemplate('products.html', {'products': prodlist, \
            ...
            'r_products':self.recommendations(1000 if not category else category), \
    ...
    def productdetail(self, productid):
        ...
        id provided. """
        print("Productdetail   {}".format(productid))
        ...
        return self.renderpackettemplate('productdetail.html', {'product':product,\
            ...
            'r_products':self.recommendations(productid), \
